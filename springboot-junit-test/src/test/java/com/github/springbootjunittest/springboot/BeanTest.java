...
public class BeanTest {
    ...
    public static void loadBeanDefinitions() {
        RootBeanDefinition aBeanDefinition = new RootBeanDefinition(TestServiceA.class);
        RootBeanDefinition bBeanDefinition = new RootBeanDefinition(TestServiceB.class);
        beanDefinitionMap.put("testServiceA", aBeanDefinition);
        beanDefinitionMap.put("testServiceB", bBeanDefinition);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        TestServiceA testServiceA = (TestServiceA) getBean("testServiceA");
        log.info("testServiceA:{}",testServiceA);
    }
